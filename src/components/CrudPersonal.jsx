                    ...
                    <tbody>
                        {this.state.data.map((personal) => (
                            <tr key={personal.id} className='table-row'>
                                <td className='table-item col-md-1'><p className='table-hidden'>Id: </p>{personal.id}</td>
                                <td className='table-item col-md-2'><p className='table-hidden'>Nombre: </p>{personal.nombre}</td>
                                <td className='table-item col-md-2'><p className='table-hidden'>Cargo: </p>{personal.cargo}</td>
                                <td className='table-item col-md-2'><p className='table-hidden'>Teléfono: </p>{personal.celular}</td>
                                <td className='table-item col-md-3'><p className='table-hidden'>Email: </p>{personal.correo}</td>
